...
response = requests.get('https://engineering-guide.eif.am/#top', headers=headers)
...
for org in orgs:
    ...
    print(id)
    resp = requests.post('https://engineering-guide.eif.am/', headers=headers, 
                         data = {'view_id': id})
...
db.to_excel('EIF_eng.xlsx', freeze_panes=(1, 1))